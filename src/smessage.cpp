// Copyright (c) 2014 The Givecoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("givecoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("givecoin-smsg-pow"); // Make this thread recognisable
...
int SecureMsgivecrypt(SecureMessage& smsg, std::string& addressFrom, std::string& addressTo, std::string& message)
{
...
int SecureMsgSend(std::string& addressFrom, std::string& addressTo, std::string& message, std::string& sError)
{
    ...
    */
    ...
    if ((rv = SecureMsgivecrypt(smsg, addressFrom, addressTo, message)) != 0)
    {
    ...
    } else
    {
        ...
        if ((rv = SecureMsgivecrypt(smsgForOutbox, addressFrom, addressOutbox, message)) != 0)
        {
