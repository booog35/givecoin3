    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("Givecoin") + " - " + tr("Wallet"));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Givecoin address"));
    ...
    stakeCoinsAction->setCheckable(false);
	stakeCoinsAction->setVisible(false);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Givecoin"), this);
    aboutAction->setToolTip(tr("Show information about Givecoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Givecoin"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    QLabel* giveCorner = new QLabel(w);
    giveCorner->setText("<html><head/><body><p><img src=\":/icons/givecoin-32\"/></p></body></html>");
    layout->addWidget(giveCorner);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Givecoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Givecoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Givecoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Givecoin address or malformed URI parameters."));
    }
