    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Givecoin address (e.g. 2XywGBZBowrppUwwNUo1GCRDTibzJi7g2M)"));
    ...
    ui->labelBlockSize->setText(QString("0 GIVE"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid Givecoin address"));
        }
        else
        {
