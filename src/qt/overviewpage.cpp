    ...
    filter(0)
{
	...
	ui->labelYourDonations->setFont(overviewBalances);
	ui->labelYourDonations->setContentsMargins(0, 0, 0, 5);
	ui->labelTotalDonations->setFont(overviewBalances);
	ui->labelTotalDonations->setContentsMargins(0, 0, 0, 5);
...
void OverviewPage::setBalance(qint64 balance, qint64 minted, qint64 stake, qint64 unconfirmedBalance, qint64 confirmingBalance, qint64 immatureBalance)
{
	...
	ui->labelYourDonations->setText(BitcoinUnits::formatWithUnit(unit, balance, false, 2));
	ui->labelTotalDonations->setText(BitcoinUnits::formatWithUnit(unit, balance, false, 2));
...
void OverviewPage::sendRequest()
{
    ...
    QString strURL = "https://api.coinmarketcap.com/v1/ticker/givecoin/";
