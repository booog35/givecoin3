...
macx {
    ...
    ICON = src/qt/res/icons/givecoin.icns
...
isEmpty(BOOST_LIB_SUFFIX) {
    ...
    windows:BOOST_LIB_SUFFIX = -mgw53-mt-s-x32-1_66
}
...
isEmpty(BOOST_INCLUDE_PATH) {
    ...
    windows:BOOST_INCLUDE_PATH = C:/coin/deps/boost
}

isEmpty(BOOST_LIB_PATH) {
    macx:BOOST_LIB_PATH = /opt/local/lib
    windows:BOOST_LIB_PATH = C:/coin/deps/boost/stage/lib
}
...
isEmpty(BDB_INCLUDE_PATH) {
    ...
    windows:BDB_INCLUDE_PATH = C:/coin/deps/db-4.8.30.NC/build_unix
}

isEmpty(BDB_LIB_PATH) {
    macx:BDB_LIB_PATH = /opt/local/lib/db48
    windows:BDB_LIB_PATH = C:/coin/deps/db-4.8.30.NC/build_unix
}

isEmpty(LIBPNG_INCLUDE_PATH) {
    macx:LIBPNG_INCLUDE_PATH = /opt/local/include/libpng16
    windows:LIBPNG_INCLUDE_PATH = C:/coin/deps/libpng-1.6.34
}

isEmpty(LIBPNG_LIB_PATH) {
    macx:LIBPNG_LIB_PATH = /opt/local/lib
    windows:LIBPNG_LIB_PATH = C:/coin/deps/libpng-1.6.34/.libs
}

isEmpty(MINIUPNPC_INCLUDE_PATH) {
    macx:MINIUPNPC_INCLUDE_PATH = /opt/local/include/miniupnpc
    windows:MINIUPNPC_INCLUDE_PATH = C:/coin/deps
}

isEmpty(MINIUPNPC_LIB_PATH) {
    macx:MINIUPNPC_LIB_PATH = /opt/local/lib
    windows:MINIUPNPC_LIB_PATH = C:/coin/deps/miniupnpc
}

isEmpty(QRENCODE_INCLUDE_PATH) {
    macx:QRENCODE_INCLUDE_PATH = /opt/local/include
    windows:QRENCODE_INCLUDE_PATH = C:/coin/deps/qrencode-4.0.0
}

isEmpty(QRENCODE_LIB_PATH) {
    macx:QRENCODE_LIB_PATH = /opt/local/lib
    windows:QRENCODE_LIB_PATH=C:/coin/deps/qrencode-4.0.0/.libs
}

isEmpty(OPENSSL_INCLUDE_PATH) {
    macx:OPENSSL_INCLUDE_PATH = /opt/local/include/openssl
    windows:OPENSSL_INCLUDE_PATH = C:/coin/deps/openssl-1.0.2n/include
}

isEmpty(OPENSSL_LIB_PATH) {
    macx:OPENSSL_LIB_PATH =  /opt/local/lib
    windows:OPENSSL_LIB_PATH = C:/coin/deps/openssl-1.0.2n
}
...
macx:themes.path = $$OUT_PWD/$$DESTDIR/Givecoin-Qt.app/Contents/MacOS/themes
